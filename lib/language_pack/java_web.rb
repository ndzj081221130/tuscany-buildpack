...
module LanguagePack
  class JavaWeb < Java
    ...
    def download_tomcat(tomcat_tarball)
      puts "java_web.rb: Downloading Tomcat: #{TOMCAT_PACKAGE}"
      fetch_package TOMCAT_PACKAGE, "http://114.212.85.89:80"#http://archive.apache.org/dist/tomcat/tomcat-7/v7.0.41/bin/
